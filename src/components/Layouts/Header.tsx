    ...
    return (
        <header className={`z-40 ${themeConfig.semidark && themeConfig.menu === 'horizontal' ? 'dark' : ''}`}>
            <div className="shadow-sm">
                <div className="relative bg-white flex w-full items-center px-5 py-2.5 dark:bg-black lg:hidden">
                    <div className="horizontal-logo flex w-full lg:hidden justify-between items-center ltr:mr-2 rtl:ml-2">
                        <Link to="/" className="main-logo flex items-center shrink-0">
                            <img className="h-10 ltr:-ml-1 rtl:-mr-1 inline" src="/assets/images/logo1.svg" alt="logo" />
                        </Link>
                        <button
                            type="button"
