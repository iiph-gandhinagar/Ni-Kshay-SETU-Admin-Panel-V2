...
import TreeItemDynamicAlgo from "./TreeItemDynamicAlgo";

const TreeDropDownDynamicAlgo: React.FC<{ name?: string, subMenu?: Array<diagnosisNodesDetailsWithChildren>, isOpen: boolean, id: string, OncleseApicall: () => void }>
...
export default TreeDropDownDynamicAlgo;
